...
def main():
    ...
    if choice == '最適化の実行':
        ...
        max_individual = st.sidebar.slider('世代の個体数', value=100, min_value=50, max_value=500, step=10)
        max_generation = st.sidebar.slider('生成する世代数(n)', value=10, min_value=10, max_value=200, step=1)
